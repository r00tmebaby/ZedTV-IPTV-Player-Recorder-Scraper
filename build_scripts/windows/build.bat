@echo off
REM Build script for ZedTV IPTV Player (Windows)
REM This script tests the application and creates an executable

setlocal enableextensions enabledelayedexpansion

echo ========================================
echo ZedTV IPTV Player - Build System (Windows)
echo ========================================
echo.

REM Resolve project root (two levels up from build_scripts/windows/)
set PROJDIR=%~dp0..\..
pushd %PROJDIR%
