...
def find_lib():
    ...
    if "PYTHON_VLC_LIB_PATH" in os.environ:
        try:
            ...
            logger.error(
                "Cannot load vlcLib specified by PYTHON_VLC_LIB_PATH env. variable"
            )
            sys.exit(1)
    ...
    if sys.platform.startswith("win"):
        ...
        c = d + "vlcLib/libvlccore.dylib"
        p = d + "vlcLib/libvlc.dylib"
        ...
        if dll is None:
            try:
                ...
                raise NotImplementedError("Cannot find libvlc vlcLib")
...
class Instance(_Ctype):
    ...
    def media_new(self, mrl, *options):
        ...
        if ":" in mrl and mrl.index(":") > 1:
            ...
            m = libvlc_media_new_path(
                self, str_to_bytes(os.path.normpath(mrl))
            )
        for o in options:
    ...
    def audio_output_device_count(self, psz_audio_output):
        ...
        @return: always 0.
        """
        return libvlc_audio_output_device_count(
            self, str_to_bytes(psz_audio_output)
        )
    ...
    def vlm_set_mux(self, psz_name, psz_mux):
        ...
        @return: 0 on success, -1 on error.
        """
        return libvlc_vlm_set_mux(
            self, str_to_bytes(psz_name), str_to_bytes(psz_mux)
        )
...
class Media(_Ctype):
    ...
    def is_parsed(self):
        """Return true is the media descriptor object is parsed
         This can return true in case of failure.
    ...
    def slaves_add(self, i_type, i_priority, psz_uri):
        ...
        @version: LibVLC 3.0.0 and later.
        """
        return libvlc_media_slaves_add(
...
class MediaList(_Ctype):
    ...
    def add_media(self, mrl):
        ...
        if isinstance(mrl, basestring):
            mrl = (self.get_instance() or get_default_instance()).media_new(
                mrl
            )
...
def libvlc_track_description_release(p_track_description):
    ...
    f = _Cfunctions.get(
        "libvlc_track_description_release", None
    ) or _Cfunction(
...
def libvlc_video_get_title_description(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_video_get_title_description", None
    ) or _Cfunction(
...
def libvlc_video_get_chapter_description(p_mi, i_title):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_video_get_chapter_description", None
    ) or _Cfunction(
...
def libvlc_audio_output_device_count(p_instance, psz_audio_output):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_output_device_count", None
    ) or _Cfunction(
...
def libvlc_audio_output_device_longname(p_instance, psz_output, i_device):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_output_device_longname", None
    ) or _Cfunction(
...
def libvlc_media_discoverer_new_from_name(p_inst, psz_name):
    ...
    f = _Cfunctions.get(
        "libvlc_media_discoverer_new_from_name", None
    ) or _Cfunction(
...
def libvlc_media_discoverer_event_manager(p_mdis):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_discoverer_event_manager", None
    ) or _Cfunction(
...
def libvlc_event_detach(
    p_event_manager, i_event_type, f_callback, p_user_data
):
    """Unregister an event notification.
...
def libvlc_module_description_list_release(p_list):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_module_description_list_release", None
    ) or _Cfunction(
...
def libvlc_media_get_codec_description(i_type, i_codec):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_get_codec_description", None
    ) or _Cfunction(
...
def libvlc_media_discoverer_media_list(p_mdis):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_discoverer_media_list", None
    ) or _Cfunction(
...
def libvlc_media_discoverer_is_running(p_mdis):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_discoverer_is_running", None
    ) or _Cfunction(
...
def libvlc_media_discoverer_list_get(p_inst, i_cat, ppp_services):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_discoverer_list_get", None
    ) or _Cfunction(
...
def libvlc_media_discoverer_list_release(pp_services, i_count):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_discoverer_list_release", None
    ) or _Cfunction(
...
def libvlc_media_list_player_release(p_mlp):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_release", None
    ) or _Cfunction(
...
def libvlc_media_list_player_event_manager(p_mlp):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_event_manager", None
    ) or _Cfunction(
...
def libvlc_media_list_player_set_media_list(p_mlp, p_mlist):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_set_media_list", None
    ) or _Cfunction(
...
def libvlc_media_list_player_set_pause(p_mlp, do_pause):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_set_pause", None
    ) or _Cfunction(
...
def libvlc_media_list_player_is_playing(p_mlp):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_is_playing", None
    ) or _Cfunction(
...
def libvlc_media_list_player_get_state(p_mlp):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_get_state", None
    ) or _Cfunction(
...
def libvlc_media_list_player_play_item(p_mlp, p_md):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_play_item", None
    ) or _Cfunction(
...
def libvlc_media_list_player_previous(p_mlp):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_list_player_previous", None
    ) or _Cfunction(
...
def libvlc_media_player_new_from_media(p_md):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_new_from_media", None
    ) or _Cfunction(
...
def libvlc_media_player_event_manager(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_event_manager", None
    ) or _Cfunction(
...
def libvlc_media_player_set_renderer(p_mi, p_item):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_set_renderer", None
    ) or _Cfunction(
...
def libvlc_video_set_format_callbacks(mp, setup, cleanup):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_video_set_format_callbacks", None
    ) or _Cfunction(
...
def libvlc_media_player_set_nsobject(p_mi, drawable):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_set_nsobject", None
    ) or _Cfunction(
...
def libvlc_media_player_get_nsobject(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_get_nsobject", None
    ) or _Cfunction(
...
def libvlc_media_player_set_android_context(p_mi, p_awindow_handler):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_set_android_context", None
    ) or _Cfunction(
...
def libvlc_media_player_set_evas_object(p_mi, p_evas_object):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_set_evas_object", None
    ) or _Cfunction(
...
def libvlc_audio_set_volume_callback(mp, set_volume):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_set_volume_callback", None
    ) or _Cfunction(
...
def libvlc_audio_set_format_callbacks(mp, setup, cleanup):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_set_format_callbacks", None
    ) or _Cfunction(
...
def libvlc_media_player_get_position(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_get_position", None
    ) or _Cfunction(
...
def libvlc_media_player_set_position(p_mi, f_pos):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_set_position", None
    ) or _Cfunction(
...
def libvlc_media_player_get_chapter_count(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_get_chapter_count", None
    ) or _Cfunction(
...
def libvlc_media_player_get_title_count(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_get_title_count", None
    ) or _Cfunction(
...
def libvlc_media_player_previous_chapter(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_previous_chapter", None
    ) or _Cfunction(
...
def libvlc_media_player_next_chapter(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_next_chapter", None
    ) or _Cfunction(
...
def libvlc_media_player_program_scrambled(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_program_scrambled", None
    ) or _Cfunction(
...
def libvlc_track_description_list_release(p_track_description):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_track_description_list_release", None
    ) or _Cfunction(
...
def libvlc_video_get_spu_description(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_video_get_spu_description", None
    ) or _Cfunction(
...
def libvlc_title_descriptions_release(p_titles, i_count):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_title_descriptions_release", None
    ) or _Cfunction(
...
def libvlc_chapter_descriptions_release(p_chapters, i_count):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_chapter_descriptions_release", None
    ) or _Cfunction(
...
def libvlc_video_get_track_description(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_video_get_track_description", None
    ) or _Cfunction(
...
def libvlc_audio_output_list_release(p_list):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_output_list_release", None
    ) or _Cfunction(
...
def libvlc_audio_output_device_list_get(p_instance, aout):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_output_device_list_get", None
    ) or _Cfunction(
...
def libvlc_audio_output_device_list_release(p_list):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_output_device_list_release", None
    ) or _Cfunction(
...
def libvlc_audio_get_track_description(p_mi):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_get_track_description", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_get_preset_count():
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_get_preset_count", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_get_preset_name(u_index):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_get_preset_name", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_get_band_count():
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_get_band_count", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_new_from_preset(u_index):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_new_from_preset", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_set_preamp(p_equalizer, f_preamp):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_set_preamp", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_get_preamp(p_equalizer):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_get_preamp", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_set_amp_at_index(p_equalizer, f_amp, u_band):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_set_amp_at_index", None
    ) or _Cfunction(
...
def libvlc_audio_equalizer_get_amp_at_index(p_equalizer, u_band):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_audio_equalizer_get_amp_at_index", None
    ) or _Cfunction(
...
def libvlc_media_player_set_equalizer(p_mi, p_equalizer):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_media_player_set_equalizer", None
    ) or _Cfunction(
...
def libvlc_renderer_discoverer_release(p_rd):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_renderer_discoverer_release", None
    ) or _Cfunction(
...
def libvlc_renderer_discoverer_start(p_rd):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_renderer_discoverer_start", None
    ) or _Cfunction(
...
def libvlc_renderer_discoverer_event_manager(p_rd):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_renderer_discoverer_event_manager", None
    ) or _Cfunction(
...
def libvlc_renderer_discoverer_list_get(p_inst, ppp_services):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_renderer_discoverer_list_get", None
    ) or _Cfunction(
...
def libvlc_renderer_discoverer_list_release(pp_services, i_count):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_renderer_discoverer_list_release", None
    ) or _Cfunction(
...
def libvlc_vlm_get_media_instance_position(p_instance, psz_name, i_instance):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_vlm_get_media_instance_position", None
    ) or _Cfunction(
...
def libvlc_vlm_get_media_instance_time(p_instance, psz_name, i_instance):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_vlm_get_media_instance_time", None
    ) or _Cfunction(
...
def libvlc_vlm_get_media_instance_length(p_instance, psz_name, i_instance):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_vlm_get_media_instance_length", None
    ) or _Cfunction(
...
def libvlc_vlm_get_media_instance_rate(p_instance, psz_name, i_instance):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_vlm_get_media_instance_rate", None
    ) or _Cfunction(
...
def libvlc_vlm_get_media_instance_title(p_instance, psz_name, i_instance):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_vlm_get_media_instance_title", None
    ) or _Cfunction(
...
def libvlc_vlm_get_media_instance_chapter(p_instance, psz_name, i_instance):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_vlm_get_media_instance_chapter", None
    ) or _Cfunction(
...
def libvlc_vlm_get_media_instance_seekable(p_instance, psz_name, i_instance):
    ...
    """
    f = _Cfunctions.get(
        "libvlc_vlm_get_media_instance_seekable", None
    ) or _Cfunction(
...
if not hasattr(dll, "libvlc_free"):
    ...
    if libc_path:
        ...
        # On win32, it is impossible to guess the proper vlcLib to call
...
if __name__ == "__main__":
    ...
    def print_version():
        """Print version of this player.py and of the libvlc"""
        try:
            print(
                "%s: %s (%s)"
                % (os.path.basename(__file__), __version__, build_date)
            )
            print(
                "LibVLC version: %s (%#x)"
    ...
    if "-h" in sys.argv[:2] or "--help" in sys.argv[:2]:
        ...
        def print_info():
            ...
            try:
                ...
                print(
                    "Video size: %s" % str(player.video_get_size(0))
                )  # num=0
